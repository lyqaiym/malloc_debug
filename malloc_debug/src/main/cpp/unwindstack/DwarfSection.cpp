...
//  error_log("DwarfSection::GetCieFromOffset");
...
//  error_log("DwarfSection::FillInCieHeader");
...
//  error_log("DwarfSection::FillInCie");
...
//  error_log("DwarfSection::GetFdeFromOffset");
...
//  error_log("DwarfSection::FillInFdeHeader");
  uint32_t length32;
  if (!memory_.ReadBytes(&length32, sizeof(length32))) {
    last_error_.code = DWARF_ERROR_MEMORY_INVALID;
    last_error_.address = memory_.cur_offset();
...
//  error_log("DwarfSection::FillInFde");
...
bool DwarfSectionImpl<AddressType>::EvalExpression(const DwarfLocation& loc, Memory* regular_memory,
                                                   ...
                                                   bool* is_dex_pc) {
//  error_log("DwarfSection::EvalExpression");
...
//  error_log("DwarfSection::EvalRegister");
...
//    error_log("DwarfSection::Eval:set_pc");
    cur_regs->set_pc(0);
  } else {
    cur_regs->set_pc((*cur_regs)[cie->return_address_register]);
//    error_log("DwarfSection::Eval:set_pc=%lld",cur_regs->pc());
  }
...
bool DwarfSectionImpl<AddressType>::GetCfaLocationInfo(uint64_t pc, const DwarfFde* fde,
                                                       dwarf_loc_regs_t* loc_regs) {
//  error_log("DwarfSection::GetCfaLocationInfo");
...
//      error_log("DwarfSection::InsertFde");
...
//  error_log("DwarfSection::GetNextCieOrFde");
...
//  error_log("DwarfSection::GetFdes");
...
//  error_log("DwarfSection::GetFdeFromPc");
